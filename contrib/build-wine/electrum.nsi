...
;Variables
  ...
  !define PRODUCT_NAME "Electrum-GLC"
  !define PRODUCT_WEB_SITE "https://github.com/goldcoin/electrum-glc"
...
Section
  ...
  ;Links goldcoin: URIs to Electrum
  WriteRegStr HKCU "Software\Classes\goldcoin" "" "URL:goldcoin Protocol"
  WriteRegStr HKCU "Software\Classes\goldcoin" "URL Protocol" ""
  WriteRegStr HKCU "Software\Classes\goldcoin" "DefaultIcon" "$\"$INSTDIR\electrum.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\goldcoin\shell\open\command" "" "$\"$INSTDIR\electrum-${PRODUCT_VERSION}.exe$\" $\"%1$\""
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\goldcoin"
