...
from electrum.util import EventListener, ignore_exceptions, log_exceptions
            ...
            "pairs": {
                "BTC/BTC": {
                    ...
                    "limits": {
                        ...
                        "maximalZeroConf": {"baseAsset": 0, "quoteAsset": 0},
                    },
                    "fees": {
                        "percentage": 0.5,
                        "minerFees": {
                            "baseAsset": {
                                ...
                                "reverse": {"claim": sm.claim_fee, "lockup": sm.lockup_fee},
                            },
                            "quoteAsset": {
                                "normal": sm.normal_fee,
                                "reverse": {"claim": sm.claim_fee, "lockup": sm.lockup_fee},
