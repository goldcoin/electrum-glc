...
class TestSwapTxs(ElectrumTestCase):
    ...
    def test_claim_tx_for_successful_reverse_swap(self):
        swap_data = SwapData(
            ...
            redeem_script=bytes.fromhex(
                "8201208763a914d7a62ef0270960fe23f0f351b28caadab62c21838821030bfd61153816df786036ea293edce851d3a4b9f4a1c66bdc1a17f00ffef3d6b167750334ef24b1752102fc8128f17f9e666ea281c702171ab16c1dd2a4337b71f08970f5aa10c608a93268ac"
            ),
            preimage=bytes.fromhex(
                "f1939b5723155713855d7ebea6e174f77d41d669269e7f138856c3de190e7a36"
            ),
            prepay_hash=None,
            privkey=bytes.fromhex(
                "58fd0018a9a2737d1d6b81d380df96bf0c858473a9592015508a270a7c9b1d8d"
            ),
    ...
    def test_claim_tx_for_timing_out_forward_swap(self):
        swap_data = SwapData(
            ...
            redeem_script=bytes.fromhex(
                "a914b12bd886ef4fd9ef1c03e899123f2c4b96cec0878763210267ca676c2ed05bb6c380880f1e50b6ef91025dfa963dc49d6c5cb9848f2acf7d670339ef24b1752103d8190cdfcc7dd929a583b7ea8fa8eb1d8463195d336be2f2df94f950ce8b659968ac"
            ),
            preimage=bytes.fromhex(
                "116f62c3283e4eb0b947a9cb672f1de7321d2c2373d12cd010500adffc32b1f2"
            ),
            prepay_hash=None,
            privkey=bytes.fromhex(
                "8d30dead21f5a7a6eeab7456a9a9d449511e942abef9302153cfff84e436614c"
            ),
