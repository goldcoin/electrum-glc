...
class Test_LNRouter(ElectrumTestCase):
    ...
    async def test_find_path_for_payment(self):
        ...
        path = self.path_finder.find_path_for_payment(
            nodeA=node("a"), nodeB=node("e"), invoice_amount_msat=amount_to_send
        )
        self.assertEqual(
            [
    ...
    async def test_find_path_liquidity_hints(self):
        ...
        A -3-> B -1-> C -4-> D -5-> E
        """
        self.path_finder.liquidity_hints.update_cannot_send(
            node("b"), node("e"), channel(2), amount_to_send - 1
        )
        path = self.path_finder.find_path_for_payment(
            nodeA=node("a"), nodeB=node("e"), invoice_amount_msat=amount_to_send
        )
        ...
        """
        self.path_finder.liquidity_hints.update_cannot_send(
            node("d"), node("e"), channel(5), amount_to_send - 1
        )
        path = self.path_finder.find_path_for_payment(
            nodeA=node("a"), nodeB=node("e"), invoice_amount_msat=amount_to_send
        )
        ...
        A -3-> B -1-> C -4-> D |-5-> E
        """
        self.path_finder.liquidity_hints.update_can_send(
            node("d"), node("c"), channel(4), amount_to_send + 1000
        )
        path = self.path_finder.find_path_for_payment(
            nodeA=node("a"), nodeB=node("e"), invoice_amount_msat=amount_to_send
        )
    ...
    def test_liquidity_hints(self):
        ...
        self.assertEqual(
            fee_for_edge_msat(
                amount_to_send, DEFAULT_PENALTY_BASE_MSAT, DEFAULT_PENALTY_PROPORTIONAL_MILLIONTH
            ),
        ...
        # check penalties
        self.assertEqual(0.0, liquidity_hints.penalty(node_from, node_to, channel_id, 1_000_000))
    ...
    def test_new_onion_packet(self):
        ...
        hops_data[4]._raw_bytes_payload = bfh(
        ...
        packet = new_onion_packet(
            payment_path_pubkeys, session_key, hops_data, associated_data=associated_data
        )
        self.assertEqual(
            bfh(
    ...
    def test_process_onion_packet(self):
        ...
        hops_data = [
            ...
            OnionHopsDataSingle(
                payload={
                    ...
                    "payment_data": {
                        "payment_secret": bfh(
                            "24a33562c54507a9334e79f0dc4f17d407e6d7c61f0e2f3d0d38599502f61704"
                        ),
                        "total_msat": 10000,
                    },
                }
        ...
        self.assertEqual(
            bfh(
                ""
            ),
            packet.to_bytes(),
        )
    ...
    def test_decode_onion_error(self):
        ...
        self.assertEqual(
            bfh(
                ""
            ),
            decoded_error,
        )
