...
class TestUtil(ElectrumTestCase):
    ...
    def test_format_satoshis_msat_resolution(self):
        ...
        self.assertEqual(
            "45831275.75", format_satoshis(Decimal("45831275.748"), decimal_point=0, precision=2)
        )
        self.assertEqual(
            "45831275.748", format_satoshis(Decimal("45831275.748"), decimal_point=0, precision=3)
        )
        ...
        self.assertEqual(
            "458312.7575", format_satoshis(Decimal("45831275.748"), decimal_point=2, precision=2)
        )
        self.assertEqual(
            "458312.75748", format_satoshis(Decimal("45831275.748"), decimal_point=2, precision=3)
        )
        ...
        self.assertEqual(
            "458.3127575", format_satoshis(Decimal("45831275.748"), decimal_point=5, precision=2)
        )
        self.assertEqual(
    ...
    def test_format_fee_precision(self):
        self.assertEqual("1.666", format_fee_satoshis(1666 / 1000, precision=6))
        self.assertEqual("1.7", format_fee_satoshis(1666 / 1000, precision=1))
    ...
    def test_format_satoshis_whitespaces(self):
        ...
        self.assertEqual(
            "     0.45831275   ",
            format_satoshis(Decimal("45831275."), whitespaces=True, precision=3),
        )
        self.assertEqual(
            "     0.458312757  ",
            format_satoshis(Decimal("45831275.7"), whitespaces=True, precision=3),
        )
        self.assertEqual(
            "     0.45831275748",
            format_satoshis(Decimal("45831275.748"), whitespaces=True, precision=3),
        )
    ...
    def test_format_satoshis_add_thousands_sep(self):
        self.assertEqual(
            "178 890 000.",
            format_satoshis(Decimal(178890000), decimal_point=0, add_thousands_sep=True),
        )
        self.assertEqual(
            "458 312.757 48",
            format_satoshis(
                Decimal("45831275.748"), decimal_point=2, add_thousands_sep=True, precision=5
            ),
        )
        # is_diff
        self.assertEqual(
        ...
        self.assertEqual(
            "-0.000 012 34", format_satoshis(-1234, is_diff=True, add_thousands_sep=True)
        )
        self.assertEqual(
            "-456 789.000 012 34",
            format_satoshis(-45678900001234, is_diff=True, add_thousands_sep=True),
        )
        # num_zeros
        self.assertEqual(
            "-456 789.123 400",
            format_satoshis(-45678912340000, num_zeros=6, add_thousands_sep=True),
        )
        self.assertEqual(
            "-456 789.123 4", format_satoshis(-45678912340000, num_zeros=2, add_thousands_sep=True)
        )
        # whitespaces
        self.assertEqual(
            "      1 432.731 11",
            format_satoshis(143273111, decimal_point=5, add_thousands_sep=True, whitespaces=True),
        )
        self.assertEqual(
            "      1 432.731   ",
            format_satoshis(143273100, decimal_point=5, add_thousands_sep=True, whitespaces=True),
        )
        self.assertEqual(
            " 67 891 432.731   ",
            format_satoshis(
                6789143273100, decimal_point=5, add_thousands_sep=True, whitespaces=True
            ),
        )
        self.assertEqual(
            "       143 273 100.",
            format_satoshis(143273100, decimal_point=0, add_thousands_sep=True, whitespaces=True),
        )
        self.assertEqual(
            " 6 789 143 273 100.",
            format_satoshis(
                6789143273100, decimal_point=0, add_thousands_sep=True, whitespaces=True
            ),
        )
        self.assertEqual(
            "56 789 143 273 100.",
            format_satoshis(
                56789143273100, decimal_point=0, add_thousands_sep=True, whitespaces=True
            ),
        )
    ...
    def test_parse_URI_address_message(self):
        self._do_test_parse_URI(
            "bitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma?message=electrum%20test",
            {
                "address": "15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma",
    ...
    def test_parse_URI_address_request_url(self):
        self._do_test_parse_URI(
            "bitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma?r=http://domain.tld/page?h%3D2a8628fc2fbe",
            {
                "address": "15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma",
    ...
    def test_parse_URI_multiple_args(self):
        self._do_test_parse_URI(
            "bitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma?amount=0.00004&label=electrum-test&message=electrum%20test&test=none&r=http://domain.tld/page",
            {
                "address": "15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma",
                "amount": 4000,
                "label": "electrum-test",
    ...
    def test_parse_URI_invalid(self):
        self.assertRaises(
            InvalidBitcoinURI, parse_bip21_URI, "notbitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma"
        )
    ...
    def test_parse_URI_parameter_pollution(self):
        self.assertRaises(
            InvalidBitcoinURI,
            parse_bip21_URI,
            "bitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma?amount=0.0003&label=test&amount=30.0",
        )
    ...
    def test_parse_URI_lightning_consistency(self):
        ...
        self._do_test_parse_URI(
            "bitcoin:tb1qu5ua3szskclyd48wlfdwfd32j65phxy9yf7ytl?amount=0.0007&message=test266&lightning=",
            {
        ...
        self.assertRaises(
            InvalidBitcoinURI,
            parse_bip21_URI,
            "bitcoin:tb1qvu0c9xme0ul3gzx4nzqdgxsu25acuk9wvsj2j2?amount=0.0007&message=test266&lightning=",
        )
        # bip21 uri that includes "lightning" key. top-level amount mismatches LN amount
        self.assertRaises(
            InvalidBitcoinURI,
            parse_bip21_URI,
            "bitcoin:tb1qu5ua3szskclyd48wlfdwfd32j65phxy9yf7ytl?amount=0.0008&message=test266&lightning=",
        )
        # bip21 uri that includes "lightning" key with garbage unparseable value
        self.assertRaises(
            InvalidBitcoinURI,
            parse_bip21_URI,
            "bitcoin:tb1qu5ua3szskclyd48wlfdwfd32j65phxy9yf7ytl?amount=0.0008&message=test266&lightning=lntb700u1p3kqy26pp5l7rj7w0u5sdsj24umzdlhdasdasdasdasd",
        )

    def test_is_hash256_str(self):
        self.assertTrue(
            is_hash256_str("09a4c03e3bdf83bbe3955f907ee52da4fc12f4813d459bc75228b64ad08617c7")
        )
        self.assertTrue(
            is_hash256_str("2A5C3F4062E4F2FCCE7A1C7B4310CB647B327409F580F4ED72CB8FC0B1804DFA")
        )
    ...
    def test_is_hex_str(self):
        ...
        self.assertTrue(
            is_hex_str("2A5C3F4062E4F2FCCE7A1C7B4310CB647B327409F580F4ED72CB8FC0B1804DFA")
        )
    ...
    def test_is_integer(self):
        ...
        self.assertFalse(
            is_integer("2A5C3F4062E4F2FCCE7A1C7B4310CB647B327409F580F4ED72CB8FC0B1804DFA")
        )
    ...
    def test_is_int_or_float(self):
        ...
        self.assertFalse(
            is_int_or_float("2A5C3F4062E4F2FCCE7A1C7B4310CB647B327409F580F4ED72CB8FC0B1804DFA")
        )
    ...
    def test_chunks(self):
        self.assertEqual([[1, 2], [3, 4], [5]], list(chunks([1, 2, 3, 4, 5], 2)))
        self.assertEqual([], list(chunks(b"", 64)))
        self.assertEqual([b"12", b"34", b"56"], list(chunks(b"123456", 2)))
    ...
    def test_error_text_bytes_to_safe_str(self):
        ...
        self.assertEqual(
            "'prefix: \\x08\\x08\\x08\\x08\\x08\\x08\\x08\\x08malicious_stuff'",
            util.error_text_bytes_to_safe_str(b"prefix: " + 8 * b"\x08" + b"malicious_stuff"),
        )
        # unicode
        self.assertEqual(
            "'here is some unicode: \\\\xe2\\\\x82\\\\xbf \\\\xf0\\\\x9f\\\\x98\\\\x80 \\\\xf0\\\\x9f\\\\x98\\\\x88'",
            util.error_text_bytes_to_safe_str(
                b"here is some unicode: \xe2\x82\xbf \xf0\x9f\x98\x80 \xf0\x9f\x98\x88"
            ),
        )
        # not even unicode
        self.assertEqual(
    ...
    def test_error_text_str_to_safe_str(self):
        ...
        # unicode
        self.assertEqual(
            "'here is some unicode: \\\\u20bf \\\\U0001f600 \\\\U0001f608'",
            util.error_text_str_to_safe_str("here is some unicode: ₿ 😀 😈"),
        )

    def test_age(self):
        now = datetime(2023, 4, 16, 22, 30, 00)
        self.assertEqual("Unknown", util.age(from_date=None, since_date=now))
        # past
        self.assertEqual(
            "less than a minute ago", util.age(from_date=now.timestamp() - 1, since_date=now)
        )
        self.assertEqual(
            "1 seconds ago",
        ...
        self.assertEqual(
            "about 30 minutes ago", util.age(from_date=now.timestamp() - 1800, since_date=now)
        )
        self.assertEqual(
        ...
        self.assertEqual(
            "about 1 hour ago", util.age(from_date=now.timestamp() - 3300, since_date=now)
        )
        self.assertEqual(
            "about 2 hours ago", util.age(from_date=now.timestamp() - 8700, since_date=now)
        )
        self.assertEqual(
            "about 7 hours ago", util.age(from_date=now.timestamp() - 26700, since_date=now)
        )
        self.assertEqual(
            "about 1 day ago", util.age(from_date=now.timestamp() - 109800, since_date=now)
        )
        self.assertEqual(
            "about 3 days ago", util.age(from_date=now.timestamp() - 282600, since_date=now)
        )
        self.assertEqual(
            "about 15 days ago", util.age(from_date=now.timestamp() - 1319400, since_date=now)
        )
        self.assertEqual(
            "about 1 month ago", util.age(from_date=now.timestamp() - 3220200, since_date=now)
        )
        self.assertEqual(
            "about 3 months ago", util.age(from_date=now.timestamp() - 8317800, since_date=now)
        )
        self.assertEqual(
            "about 1 year ago", util.age(from_date=now.timestamp() - 39853800, since_date=now)
        )
        self.assertEqual(
            "over 3 years ago", util.age(from_date=now.timestamp() - 103012200, since_date=now)
        )
        # future
        self.assertEqual(
            "in less than a minute", util.age(from_date=now.timestamp() + 1, since_date=now)
        )
        self.assertEqual(
            "in 1 seconds",
            util.age(from_date=now.timestamp() + 1, since_date=now, include_seconds=True),
        ...
        self.assertEqual(
            "in about 30 minutes", util.age(from_date=now.timestamp() + 1800, since_date=now)
        )
        self.assertEqual(
            "in about 30 minutes",
            util.age(from_date=now.timestamp() + 1800, since_date=now, include_seconds=True),
        ...
        self.assertEqual(
            "in about 1 hour", util.age(from_date=now.timestamp() + 3300, since_date=now)
        )
        self.assertEqual(
            "in about 2 hours", util.age(from_date=now.timestamp() + 8700, since_date=now)
        )
        self.assertEqual(
            "in about 7 hours", util.age(from_date=now.timestamp() + 26700, since_date=now)
        )
        self.assertEqual(
            "in about 1 day", util.age(from_date=now.timestamp() + 109800, since_date=now)
        )
        self.assertEqual(
            "in about 3 days", util.age(from_date=now.timestamp() + 282600, since_date=now)
        )
        self.assertEqual(
            "in about 15 days", util.age(from_date=now.timestamp() + 1319400, since_date=now)
        )
        self.assertEqual(
            "in about 1 month", util.age(from_date=now.timestamp() + 3220200, since_date=now)
        )
        self.assertEqual(
            "in about 3 months", util.age(from_date=now.timestamp() + 8317800, since_date=now)
        )
        self.assertEqual(
            "in about 1 year", util.age(from_date=now.timestamp() + 39853800, since_date=now)
        )
        self.assertEqual(
