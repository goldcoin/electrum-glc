...
class TestCommands(ElectrumTestCase):
    ...
    async def test_convert_xkey(self):
        ...
        xpubs = {
            ...
            (
                "zpub6qs2rwG2uCL6jLfBRsMjY4JSGS6JMZZpuhUoCmH9rkgg7aJpaLeHmDgeacZQ81sx7gRfp35gY77xgAdkAgvkKS2bbkDnLDw8x8bAsuKBrvP",
                "p2wpkh",
            ),
        }
        ...
        xprvs = {
            (
                "xprv9yD9r6PJmTgqpGCUf8FUkkAhNTxv4rryiFWkqb5mYQPw8aMDXUzuyJ3tgv5vUqYkdK1E6Q5jKxPss4HkMBYV4q8AfG8t7rxgyS4xQX4ndAm",
                "standard",
            ),
            (
                "yprvAJ3R9m4Dv9EKfZPbVV36xqGCYS7N1UrUdN2ycyyevQmpBgASn9AUbMi2i83WUkCg2x82qsgHnckRkLuK4sxVs4omXbqJhmnBFA8bo8ssinK",
                "p2wpkh-p2sh",
            ),
            (
                "zprvAcsgTRj94pmoWraiKqpjAvMhiQFox6qyYUZCQNsYJR9hEmyg2oL3DRNAjL16UerbSbEqbMGrFH6yddWsnaNWfJVNPwXjHgbfWtCFBgDxFkX",
                "p2wpkh",
            ),
        }
    ...
    async def test_export_private_key_imported(self, mock_save_db):
        ...
        with self.assertRaises(UserFacingException):
            await cmds.getprivatekeys(
                "asdasd", wallet=wallet
            )  # invalid addr, though might raise "not in wallet"
        with self.assertRaises(UserFacingException):
            await cmds.getprivatekeys(
                "bc1qgfam82qk7uwh5j2xxmcd8cmklpe0zackyj6r23", wallet=wallet
            )  # not in wallet
        self.assertEqual(
        ...
        with self.assertRaises(UserFacingException):
            await cmds.getprivatekeys(
                ["bc1q2ccr34wzep58d4239tl3x3734ttle92a8srmuw", "asd"], wallet=wallet
            )
        self.assertEqual(
            [
                "p2wpkh:L4jkdiXszG26SUYvwwJhzGwg37H2nLhrbip7u6crmgNeJysv5FHL",
            ...
            await cmds.getprivatekeys(
                [
                    ...
                    "bc1q9pzjpjq4nqx5ycnywekcmycqz0wjp2nq604y2n",
                ],
                wallet=wallet,
            ),
        )
    ...
    async def test_export_private_key_deterministic(self, mock_save_db):
        ...
        with self.assertRaises(UserFacingException):
            await cmds.getprivatekeys(
                ["bc1q3g5tmkmlvxryhh843v4dz026avatc0zzr6h3af", "asd"], wallet=wallet
            )
        self.assertEqual(
            [
                "p2wpkh:L15oxP24NMNAXxq5r2aom24pHPtt3Fet8ZutgL155Bad93GSubM2",
...
class TestCommandsTestnet(ElectrumTestCase):
    ...
    async def test_convert_xkey(self):
        ...
        xpubs = {
            (
                "tpubD8p5qNfjczgTGbh9qgNxsbFgyhv8GgfVkmp3L88qtRm5ibUYiDVCrn6WYfnGey5XVVw6Bc5QNQUZW5B4jFQsHjmaenvkFUgWtKtgj5AdPm9",
                "standard",
            ),
            (
                "upub59wfQ8qJTg6ZSuvwtR313Qdp8gP8TSBwTof5dPQ3QVsYp1N9t29Rr9TGF1pj8kAXUg3mKbmrTKasA2qmBJKb1bGUzB6ApDZpVC7LoHhyvBo",
                "p2wpkh-p2sh",
            ),
            (
                "vpub5UmvhoWDcMe3JD84impdFVjKJeXaQ4BSNvBJQnHvnWFRs7BP8gJzUD7QGDnK8epStKAa55NQuywR3KTKtzjbopx5rWnbQ8PJkvAzBtgaGBc",
                "p2wpkh",
            ),
        }
        for xkey1, xtype1 in xpubs:
        ...
        xprvs = {
            (
                "tprv8c83gxdVUcznP8fMx2iNUBbaQgQC7MUbBUDG3c6YU9xgt7Dn5pfcgHUeNZTAvuYmNgVHjyTzYzGWwJr7GvKCm2FkPaaJipyipbfJeB3tdPW",
                "standard",
            ),
            (
                "uprv8vxJzdJQdJYGERrUnPVzgGh5aeYe3yU66ajUpzzRrALZwD31LUqBJM8nPmQkvpCgnKc6VT4Z1ed4pbTfzcjDZFwMFvGjJjoD6Kix2pCwVe7",
                "p2wpkh-p2sh",
            ),
            (
                "vprv9FnaJHyKmz5k5j3bckHctMnakch5zbTb1hFhcPtKEAiSzJrEb8zjvQnvQyNLvircBxiuEvf7UJycht5EiK9EMVcx8Fy9techN3nbRQRFhEv",
                "p2wpkh",
            ),
        }
        for xkey1, xtype1 in xprvs:
    ...
    async def test_getprivatekeyforpath(self, mock_save_db):
        ...
        cmds = Commands(config=self.config)
        self.assertEqual(
            "p2wpkh:cUzm7zPpWgLYeURgff4EsoMjhskCpsviBH4Y3aZcrBX8UJSRPjC2",
    ...
    async def test_bumpfee(self, mock_save_db):
        ...
        self.assertEqual(
            ...
            await cmds.bumpfee(
                tx=orig_rawtx,
                new_fee_rate="1.6",
                from_coins="9a8cba08b79d73d8b602e8748a2c8a09cdd200a0393561f68e05af69fc3d72b9:1",
                wallet=wallet,
            ),
        )
