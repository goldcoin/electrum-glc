...
class TestBolt11(ElectrumTestCase):
        ...
        tests = [
            ...
            (
                LnAddr(
                    ...
                    tags=[("d", "1 cup coffee"), ("x", 60), ("9", 0x28200)],
                ),
            ...
            (
                LnAddr(
                    ...
                    payment_secret=PAYMENT_SECRET,
                    amount=Decimal("1"),
                    tags=[("h", longdescription), ("9", 0x28200)],
                ),
            ...
            (
                LnAddr(
                    ...
                    payment_secret=PAYMENT_SECRET,
                    amount=24,
                    tags=[("n", PUBKEY), ("h", longdescription), ("9", 0x28200)],
                ),
            ...
            (
                LnAddr(
                    ...
                    payment_secret=PAYMENT_SECRET,
                    amount=24,
                    tags=[("h", longdescription), ("9", 2 + (1 << 9) + (1 << 15))],
                ),
            ...
            (
                LnAddr(
                    ...
                    payment_secret=PAYMENT_SECRET,
                    amount=24,
                    tags=[("h", longdescription), ("9", 10 + (1 << 8) + (1 << 15))],
                ),
            ...
            (
                LnAddr(
                    ...
                    payment_secret=PAYMENT_SECRET,
                    amount=24,
                    tags=[("h", longdescription), ("9", 10 + (1 << 9) + (1 << 15))],
                ),
            ...
            (
                LnAddr(
                    ...
                    payment_secret=PAYMENT_SECRET,
                    amount=24,
                    tags=[("h", longdescription), ("9", 10 + (1 << 9) + (1 << 14))],
                ),
            ...
            [
                ...
                (
                    LnAddr(
                        ...
                        paymenthash=RHASH,
                        net=constants.BitcoinTestnet,
                        tags=[("f", "mk2QpYatsKicvFVuTAQLBryyccRXMUaGHP"), ("h", longdescription)],
                    ),
    ...
    def test_n_decoding(self):
        ...
        databits.invert(-1)
        lnaddr = lndecode(
            bech32_encode(segwit_addr.Encoding.BECH32, hrp, bitarray_to_u5(databits)), verbose=True
        )
    ...
    def test_min_final_cltv_expiry_roundtrip(self):
        for cltv in (1, 15, 16, 31, 32, 33, 150, 511, 512, 513, 1023, 1024, 1025):
            lnaddr = LnAddr(
                paymenthash=RHASH,
                payment_secret=b"\x01" * 32,
                amount=Decimal("0.001"),
                tags=[("d", "1 cup coffee"), ("x", 60), ("c", cltv), ("9", 33282)],
            )
    ...
    def test_derive_payment_secret_from_payment_preimage(self):
        ...
        self.assertEqual(
            "bfd660b559b3f452c6bb05b8d2906f520c151c107b733863ed0cc53fc77021a8",
