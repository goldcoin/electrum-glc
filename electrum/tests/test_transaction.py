...
signed_blob_signatures = [
    "3046022100a82bbc57a0136751e5433f41cf000b3f1a99c6744775e76ec764fb78c54ee100022100f9e80b7de89de861dc6fb0c1429d5da72c2b6b2ee2406bc9bfb1beedd729d98501",
]
...
class TestTransaction(ElectrumTestCase):
    ...
    def test_tx_update_signatures(self):
        tx = tx_from_any(
            "cHNidP8BAFUBAAAAASpcmpT83pj1WBzQAWLGChOTbOt1OJ6mW/OGM7Qk60AxAAAAAAD/////AUBCDwAAAAAAGXapFCMKw3g0BzpCFG8R74QUrpKf6q/DiKwAAAAAAAAA"
        )
        ...
        desc = descriptor.get_singlesig_descriptor_from_legacy_leaf(
            pubkey=pubkey.hex(), script_type=script_type
        )
    ...
    def test_tx_setting_locktime_invalidates_ser_cache(self):
        tx = tx_from_any(
            ""
        )
        self.assertEqual(
            "2774c819a05e44861a0555401d2741e6c03079cc4d892c69b910c0f52f407859", tx.txid()
        )
        tx.locktime = 111222333
        self.assertEqual(
            "3d33a69c3f7717840b266c24ae1a6d29486820249b47261232e93ee118a6565b", tx.txid()
        )
    ...
    def test_tx_setting_version_invalidates_ser_cache(self):
        ...
        tx.version = 555
        self.assertEqual(
            "8a9b89a1a7aac1995dd013069d9866197d77c14c22315958d612fc02fd4b596a", tx.txid()
        )
    ...
    def test_tx_deserialize_for_signed_network_tx(self):
        ...
        self.assertEqual(
            bfh(
                "493046022100a82bbc57a0136751e5433f41cf000b3f1a99c6744775e76ec764fb78c54ee100022100f9e80b7de89de861dc6fb0c1429d5da72c2b6b2ee2406bc9bfb1beedd729d985012102e61d176da16edd1d258a200ad9759ef63adf8e14cd97f53227bae35cdb84d2f6"
            ),
        ...
        self.assertEqual(
            bfh("76a914230ac37834073a42146f11ef8414ae929feaafc388ac"), tx.outputs()[0].scriptpubkey
        )
    ...
    def test_estimated_output_size(self):
        ...
        self.assertEqual(
            estimated_output_size("bc1qnvks7gfdu72de8qv6q6rhkkzu70fqz4wpjzuxjf6aydsx7wxfwcqnlxuv3"),
            43,
        )
    ...
    def test_version_field(self):
        ...
        self.assertEqual(
            tx.txid(), "b97f9180173ab141b61b9f944d841e60feec691d6daab4d4d932b24dd36606fe"
        )
    ...
    def test_get_address_from_output_script(self):
        ...
        self.assertEqual(
            ...
            addr_from_script("76a914704f4b81cadb7bf7e68c08cd3657220f680f863c88ac"),
        )
        # almost but not quite
    ...
    def test_tx_serialize_methods_for_psbt(self):
        ...
        self.assertEqual(raw_base64, partial_tx.serialize())
        self.assertEqual(raw_hex, partial_tx.serialize_as_bytes().hex())
        self.assertEqual(raw_base64, partial_tx._serialize_as_base64())
    ...
    def test_tx_serialize_methods_for_network_tx(self):
        ...
        self.assertEqual(raw_hex, tx.serialize())
        self.assertEqual(raw_hex, tx.serialize_as_bytes().hex())
    ...
    def test_tx_serialize_methods_for_psbt_that_is_ready_to_be_finalized(self):
        ...
        self.assertEqual(PartialTransaction, type(partial_tx))
        self.assertEqual(raw_hex_network_tx, partial_tx.serialize())
        self.assertEqual(raw_hex_network_tx, partial_tx.serialize_as_bytes().hex())
    ...
    def test_tx_from_any(self):
        ...
        raw_tx_map = {
            ...
            "network_tx_hex_bytes": RawTx(
                b""
            ),
            "network_tx_base43_str": RawTx(
            ...
            "network_tx_base43_bytes": RawTx(
                b"3E2DH7.J3PKVZJ3RCOXQVS3Y./6-WE.75DDU0K58-0N1FRL565N8ZH-DG1Z.1IGWTE5HK8F7PWH5P8+V3XGZZ6GQBPHNDE+RD8CAQVV1/6PQEMJIZTGPMIJ93B8P$QX+Y2R:TGT9QW8S89U4N2.+FUT8VG+34USI/N/JJ3CE*KLSW:REE8T5Y*9:U6515JIUR$6TODLYHSDE3B5DAF:5TF7V*VAL3G40WBOM0DO2+CFKTTM$G-SO:8U0EW:M8V:4*R9ZDX$B1IRBP9PLMDK8H801PNTFB4$HL1+/U3F61P$4N:UAO88:N5D+J:HI4YR8IM:3A7K1YZ9VMRC/47$6GGW5JEL1N690TDQ4XW+TWHD:V.1.630QK*JN/.EITVU80YS3.8LWKO:2STLWZAVHUXFHQ..NZ0:.J/FTZM.KYDXIE1VBY7/:PHZMQ$.JZQ2.XT32440X/HM+UY/7QP4I+HTD9.DUSY-8R6HDR-B8/PF2NP7I2-MRW9VPW3U9.S0LQ.*221F8KVMD5ANJXZJ8WV4UFZ4R.$-NXVE+-FAL:WFERGU+WHJTHAP"
            ),
            "network_tx_raw_bytes": RawTx(
                bytes.fromhex(
                    ""
                ),
            ...
            "psbt_hex_bytes": RawTx(
                b""
            ),
            "psbt_base64_str": RawTx(
                ""
            ),
            "psbt_base64_bytes": RawTx(
                b""
            ),
            "psbt_base43_str": RawTx(
            ...
            "psbt_base43_bytes": RawTx(
                b"EFS+4WQ2R.5QWTVLQS.BWHG21Q-M0HVA+KKLG+9RYJ2B/GHJ$3OUOKH32U0NISGM$CI*KI24$PKQI0F*GA..*DW:UJ4FM-6S3B*VIJ0.M8M*DVCR9+TNG2R/IMZY0A72MS8+QMTO*:25V577L*DRC78WBK0BNAK7/8JQR-FA/L-KNBBKTQRZEU93T/Z/.7OBC6A7WWZ49DNHLG:X37ISM2+.ZT4ZC00.G8K8O6NM48GRR+N/-W/ASXT5VLPPHPRWR2PHMLZWDYAN8DMW$1EKD/EU4LHQWIKM0N42B*/32MQ1C:I17FMQVVQF6OA*X1RW8X.H17040FPH8/L5HBPFTTT0PMJGR9I0/J0+4PS5WJE/:W-Y.YA:SMFZMO36IMK0P/KUHVR.44OPT$TD*ZHSPZVULFWH75T+APO636*NYL19ZJIU3N37$KN7OY7*WOA498BWCPM$G6::C:YPDZ:PUISTZB-RL**B/QAX+HA*55O+:R/L8*J9B*G:QU6FS+HS+:OXPKOP-GDJK$NU72E4Y11BZENGIJWLWZ+C:01G$H-*LY5.LGC5I1A4G7$KT9BZ81LEPV5D09RAKI5BW1*O8QWMIIG17/8$J0X:W7F9FC7EMQRLESY2NNNVLZTHWB/FJVB-*.5JU0GQ*3JIBTQ$OR3AHTJ-U-C-8MWV$R::*VTRY-2+*H7U594$0JCN27R9*TY0+8:3Q7T/HES5OF*GLL::5Z8M$JNCLLKH6:J:GCT$E:27AXUA1L4ROJO3*-86C2QH.9TBNP0SS51XRL/J7:-+QES+37SOZIJCKG2XOUVPJR:F+MGS1L6-8/YA.6BKZ+FMF8F:OT2P4X:9M4P8IGM-/UUSS8S5*8YMZ$S+JKY.DHDCY$$+F53TGYK1.RHYA68-KO3O:$$IO/R9995TPAE6FF6$UOAUD5A2YLY.Q$VE$Q*0437K-DHKRFM$Q$3G:58+GER9D.6S$EW++HBBE0T62MAA/$-A2OV22QHY.JHK:6GNT.QQ*5YWZKCZI$+IQPU0UT/0H0PR9BYB1BB-Y+A.Q2HD$JP+:AT0CQR$R3PVHC9K/IPTVWJK0J4$J-B-CL6713L5PM-33-.CHXGJ$*ME.U-71V2JNX*W7JYC$V2VEEL:3GU3HGV84O.5PT+K*NB/2.-0.GCQNJ*ZOC$M2Y86V:URJ4/.ZVK6X1I--.B9NAWE54IDPLRN0FSWYGA/INDLPUBW7SZ/YADHWFLU*MWI121O2Y56QWG.EFNLSIVAVXYF$.:N/OU-PS7U/*Z94CR7T0+.F+RL9.-U5FQ1QL/A2$O2E0$TP-AX4*55QET9BPH6:K+CD$.+$*F0BUWSW.*$IF*WIC+UMJRZP5.50V1DMTIZ.D/2+$0T-GDBE7LHPGY0X0:G/*ZPTAMQABEC4HPML4UCLSAR-.5UT-X1.PMM60HUFAF"
            ),
            "psbt_raw_bytes": RawTx(
                bytes.fromhex(
                    ""
                ),
                is_whitespace_allowed=False,
...
class TestTransactionTestnet(ElectrumTestCase):
    ...
    def test_spending_op_cltv_p2sh(self):
        ...
        prevout = TxOutpoint(
            txid=bfh("6d500966f9e494b38a04545f0cea35fc7b3944e341a64b804fed71cdee11d434"), out_idx=1
        )
        ...
        self.assertEqual(
            "3266138b0b79007f35ac9a1824e294763708bd4a6440b5c227f4e1251b66e92b", tx.txid()
        )
    ...
    def test_spending_op_cltv_p2wsh(self):
        ...
        self.assertEqual(
            "tb1q9dn6qke9924xe3zmptmhrdge0s043pjxpjndypgnu2t9fvsd4crs2qjuer", from_addr
        )
        prevout = TxOutpoint(
            txid=bfh("8680971efd5203025cffe746f8598d0a704fae81f236ffe009c2609ec673d59a"), out_idx=0
        )
        txin = PartialTxInput(prevout=prevout)
        ...
        self.assertEqual(
            "1cdb274755b144090c7134b6459e8d4cb6b4552fe620102836d751e8389b2694", tx.txid()
        )
        self.assertEqual(
...
class TestSighashTypes(ElectrumTestCase):
    ...
    locktime = 0
    prevout = TxOutpoint(
        txid=bfh("6eb98797a21c6c10aa74edf29d618be109f48a8e94c694f3701e08ca69186436"), out_idx=1
    )
    txin = PartialTxInput(prevout=prevout)
    txin.nsequence = 0xFFFFFFFF
    txin.witness_script = bfh(
    ...
    txout1 = PartialTxOutput(
        scriptpubkey=bfh("76a914389ffce9cd9ae88dcc0631e88a821ffdbe9bfe2688ac"), value=900000000
    )
    txout2 = PartialTxOutput(
        scriptpubkey=bfh("76a9147480a33f950689af511e6e84c138dbbd3c3ee41588ac"), value=87000000
    )
    ...
    def test_check_sighash_types_sighash_all(self):
        ...
        tx = PartialTransaction.from_io(
            inputs=[self.txin],
            outputs=[self.txout1, self.txout2],
