...
def scrypt_1024_1_1_80(header):
    ...
    for i in range(4):
        ...
        for j in range(8):
            X[i * 8 + j] = (
                H[j * 4 + 0] << 0 | H[j * 4 + 1] << 8 | H[j * 4 + 2] << 16 | H[j * 4 + 3] << 24
            )
...
def _xor_salsa8_2(X):
    ...
    for j in range(4):
        ...
        t08 ^= (t >> 23) | (t << 9)
        t = t08 + t04 & 0xFFFFFFFF
        t12 ^= (t >> 19) | (t << 13)
        t = t12 + t08 & 0xFFFFFFFF
        t00 ^= (t >> 14) | (t << 18)
        t = t05 + t01 & 0xFFFFFFFF
        t09 ^= (t >> 25) | (t << 7)
        t = t09 + t05 & 0xFFFFFFFF
        t13 ^= (t >> 23) | (t << 9)
        t = t13 + t09 & 0xFFFFFFFF
        t01 ^= (t >> 19) | (t << 13)
        t = t01 + t13 & 0xFFFFFFFF
        t05 ^= (t >> 14) | (t << 18)
        t = t10 + t06 & 0xFFFFFFFF
        t14 ^= (t >> 25) | (t << 7)
        t = t14 + t10 & 0xFFFFFFFF
        t02 ^= (t >> 23) | (t << 9)
        t = t02 + t14 & 0xFFFFFFFF
        t06 ^= (t >> 19) | (t << 13)
        t = t06 + t02 & 0xFFFFFFFF
        t10 ^= (t >> 14) | (t << 18)
        t = t15 + t11 & 0xFFFFFFFF
        t03 ^= (t >> 25) | (t << 7)
        t = t03 + t15 & 0xFFFFFFFF
        t07 ^= (t >> 23) | (t << 9)
        t = t07 + t03 & 0xFFFFFFFF
        t11 ^= (t >> 19) | (t << 13)
        t = t11 + t07 & 0xFFFFFFFF
        t15 ^= (t >> 14) | (t << 18)
        t = t00 + t03 & 0xFFFFFFFF
        t01 ^= (t >> 25) | (t << 7)
        t = t01 + t00 & 0xFFFFFFFF
        t02 ^= (t >> 23) | (t << 9)
        t = t02 + t01 & 0xFFFFFFFF
        t03 ^= (t >> 19) | (t << 13)
        t = t03 + t02 & 0xFFFFFFFF
        t00 ^= (t >> 14) | (t << 18)
        t = t05 + t04 & 0xFFFFFFFF
        t06 ^= (t >> 25) | (t << 7)
        t = t06 + t05 & 0xFFFFFFFF
        t07 ^= (t >> 23) | (t << 9)
        t = t07 + t06 & 0xFFFFFFFF
        t04 ^= (t >> 19) | (t << 13)
        t = t04 + t07 & 0xFFFFFFFF
        t05 ^= (t >> 14) | (t << 18)
        t = t10 + t09 & 0xFFFFFFFF
        t11 ^= (t >> 25) | (t << 7)
        t = t11 + t10 & 0xFFFFFFFF
        t08 ^= (t >> 23) | (t << 9)
        t = t08 + t11 & 0xFFFFFFFF
        t09 ^= (t >> 19) | (t << 13)
        t = t09 + t08 & 0xFFFFFFFF
        t10 ^= (t >> 14) | (t << 18)
        t = t15 + t14 & 0xFFFFFFFF
        t12 ^= (t >> 25) | (t << 7)
        t = t12 + t15 & 0xFFFFFFFF
        t13 ^= (t >> 23) | (t << 9)
        t = t13 + t12 & 0xFFFFFFFF
        t14 ^= (t >> 19) | (t << 13)
        t = t14 + t13 & 0xFFFFFFFF
        t15 ^= (t >> 14) | (t << 18)
...
if __name__ == "__main__":
    ...
    vectors = [
        ...
        (
            ...
            "461ae94540dc88c9bffbf42bb47e46a2416280adbeeb1d883c18090000000000",
        ),
    ]
